...
from app.main import app, _fuse_candidates, retrieve_hybrid
...
class RetrievalIntegrationTests(unittest.TestCase):
    ...
    def test_multi_course_hybrid_retrieval_interleaves_course_batches(
        ...
        def dense_side_effect(cursor_arg, vector, limit, course_slugs=None):
            slug = course_slugs[0]
            return [
        ...
        def sparse_side_effect(cursor_arg, question, limit, course_slugs=None):
            slug = course_slugs[0]
            return [
